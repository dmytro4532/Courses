...
namespace Courses.Infrastructure.Migrations
{
    ...
    [Migration("20250525152658_UserTestAnswersToJson")]
    partial class UserTestAnswersToJson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Courses.Domain.UserTest.UserTestAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<IReadOnlyCollection<Answer>>("PossibleAnswers")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<IReadOnlyCollection<Guid>>("SelectedAnswerIds")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<Guid>("UserTestAttemptId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserTestAnswer", (string)null);
                });

            modelBuilder.Entity("Courses.Domain.UserTest.UserTestAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Courses.Domain.UserTest.UserTestAnswer", b =>
                {
                    b.HasOne("Courses.Domain.UserTest.UserTestAttempt", "UserTestAttempt")
                        .WithMany("Answers")
